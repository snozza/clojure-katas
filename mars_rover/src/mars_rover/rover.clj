...
(defmethod move-forwards :east [{x :x y :y}]
  (rover (inc x) y direction))

(defmethod move-forwards :west [{x :x y :y}]
...
(defmethod move-backwards :south [{x :x y :y}]
  (rover x (inc y) direction))

(defmethod move-backwards :east [{x :x y :y}]
  (rover (dec x) y direction))

(defmethod move-backwards :west [{x :x y :y}]
  (rover (inc x) y direction))
